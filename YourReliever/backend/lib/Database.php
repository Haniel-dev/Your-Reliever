<?php
// mysqli-backed compatibility layer exposing a minimal PDO-like API used by this project
class Database {
  private static $mysqli = null; // \mysqli
  private static $pseudo = null; // PseudoPDO
